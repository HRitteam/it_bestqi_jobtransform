...
var FIXED_INDUSTRY = "\u667A\u80FD\u5BB6\u5C45\u4E0E\u6D88\u8D39\u7535\u5B50\u884C\u4E1A";
var FIXED_COMPANY_NAME = "BestQI Innovation Technology Co., Ltd.";
var FIXED_COMPANY_PROFILE = `BestQI Innovation Technology Co., Ltd. \u6210\u7ACB\u4E8E2016\u5E74\uFF0C\u662F\u4E00\u5BB6\u4E13\u6CE8\u4E8E\u667A\u80FD\u5BB6\u5C45\u3001\u5BB6\u5EAD\u5F71\u97F3\u8BBE\u5907\u53CA\u4EBA\u4F53\u5DE5\u5B66\u4EA7\u54C1\u7814\u53D1\u3001\u751F\u4EA7\u4E0E\u5168\u7403\u9500\u552E\u7684\u521B\u65B0\u578B\u4F01\u4E1A\u3002\u516C\u53F8\u4F9D\u6258\u5B8C\u5584\u7684\u4F9B\u5E94\u94FE\u4F53\u7CFB\u3001\u56FD\u9645\u5316\u7269\u6D41\u7F51\u7EDC\u4EE5\u53CA\u4E13\u4E1A\u7814\u53D1\u56E2\u961F\uFF0C\u6301\u7EED\u4E3A\u5168\u7403\u6D88\u8D39\u8005\u63D0\u4F9B\u517C\u5177\u8BBE\u8BA1\u7F8E\u5B66\u4E0E\u5B9E\u7528\u4EF7\u503C\u7684\u9AD8\u54C1\u8D28\u4EA7\u54C1\u89E3\u51B3\u65B9\u6848\u3002
        ...
        for (const file of expandedFiles) {
          ...
          try {
            ...
            try {
              ...
              console.warn(`[Submit] S3 upload failed for ${file.originalname}, continuing without storage:`, storageErr.message);
            }
            try {
              if (db) {
              ...
              console.warn(`[Submit] Failed to save file record for ${file.originalname}, continuing:`, dbErr.message);
            }
            const allContent = [extracted, text2].filter(Boolean).join("\n\n");
            ...
            const reportInputText = extracted && extracted.trim() && !extracted.startsWith("[") ? extracted.slice(0, 1e4) : text2;
            if (db) {
              await db.insert(reports).values({
                reportId,
                userId: user.id,
    ...
    if (ext === "pdf" || mimeType === "application/pdf") {
      ...
      try {
        ...
        try {
          ...
          const text2 = result?.pages?.map((p) => p.text || "").join("\n") || "";
          if (text2.trim()) {
